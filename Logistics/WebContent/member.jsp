...
<body>
	...
	<form action="#" method="post">
		...
		Select Number of Trains (0-5): <input type="range" id="rating" min="0"
			max="5" onchange="evalSlider()" />
		<output id="sliderVal"></output>
		<br> Select Number of Tanks (0-5): <input type="range"
			id="rating1" min="0" max="5" onchange="evalSlider1()" />
